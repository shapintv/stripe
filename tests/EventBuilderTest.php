...
final class EventBuilderTest extends TestCase
{
    ...
    public function unsupportedEvents()
    {
        ...
        yield ['coupon.created'];
        yield ['coupon.deleted'];
        yield ['coupon.updated'];
        yield ['customer.discount.created'];
        yield ['customer.discount.deleted'];
        yield ['customer.discount.updated'];
        yield ['file.created'];
        yield ['invoice.created'];
        yield ['invoice.deleted'];
        yield ['invoice.finalized'];
        yield ['invoice.marked_uncollectible'];
        yield ['invoice.payment_failed'];
        yield ['invoice.payment_succeeded'];
        yield ['invoice.sent'];
        yield ['invoice.upcoming'];
        yield ['invoice.updated'];
        yield ['invoice.voided'];
        yield ['invoiceitem.created'];
        yield ['invoiceitem.deleted'];
        yield ['invoiceitem.updated'];
